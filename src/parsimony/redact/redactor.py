...
from parsimony.model import RedactionReport
from parsimony.redact.patterns import DEFAULT_PATTERNS, SecretPattern
...
class Redactor:
    ...
    Implements :class:`parsimony.ports.RedactorPort`. Model-free and deterministic; it is
    ...
    Args:
        patterns: Detection rules to apply. Defaults to
            :data:`parsimony.redact.patterns.DEFAULT_PATTERNS`.
    """
