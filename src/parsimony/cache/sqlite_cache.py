...
:func:`parsimony.cache.key.compute_key` (prompts themselves are never stored). The store is
...
from parsimony.ports import ClockPort
...
class SqliteCache:
    ...
    Implements :class:`parsimony.ports.CachePort`.
